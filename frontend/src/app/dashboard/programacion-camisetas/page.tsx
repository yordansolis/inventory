...
// interface DaySchedule {
//   id?: number;  // Añadimos id opcional para manejar mejor las keys
//   day: string;
//   dayName: string;
//   color: string;
//   colorName: string;
...
//     { id: 1, day: 'monday', dayName: 'Lunes', color: '#ffffff', colorName: 'Blanco' },
//     { id: 2, day: 'tuesday', dayName: 'Martes', color: '#ec4899', colorName: 'Rosa' },
//     { id: 3, day: 'wednesday', dayName: 'Miércoles', color: '#8b5cf6', colorName: 'Morado' },
//     { id: 4, day: 'thursday', dayName: 'Jueves', color: '#6b7280', colorName: 'Gris' },
//     { id: 5, day: 'friday', dayName: 'Viernes', color: '#dc2626', colorName: 'Rojo Oscuro' },
//     { id: 6, day: 'saturday', dayName: 'Sábado', color: '#ec4899', colorName: 'Rosa' },
//     { id: 7, day: 'sunday', dayName: 'Domingo', color: '#8b5cf6', colorName: 'Morado' },
//   ]);
...
//       if (data.success && data.schedule) {
//         // Asignar IDs a los días si no vienen de la API
//         const scheduleWithIds = data.schedule.map((day, index) => ({
//           ...day,
//           id: day.id || index + 1
//         }));
...
//         localStorage.setItem('camiseta-schedule', JSON.stringify(scheduleWithIds));
//       }
//     } catch (error) {
//       console.error("Error al cargar la programación:", error);
//       setError(error instanceof Error ? error.message : "Error desconocido");
...
//         try {
//           const parsedSchedule = JSON.parse(savedSchedule);
//           // Asegurarse de que los días tienen IDs
//           const scheduleWithIds = parsedSchedule.map((day: DaySchedule, index: number) => ({
//             ...day,
//             id: day.id || index + 1
//           }));
//           setSchedule(scheduleWithIds);
...
//       // No actualizamos localStorage en caso de error para mantener consistencia
//     } finally {
//       setUpdatingDay(null);
//     }
//   };
...
//           {schedule.map((daySchedule) => (
//             <div
//               key={daySchedule.id || `${daySchedule.day}-${daySchedule.color}`} // Usar ID o una combinación única como fallback
//               className={`border-2 rounded-lg p-4 cursor-pointer transition-all hover:shadow-md ${
//                 currentDay === daySchedule.day 
//                   ? 'border-green-500 bg-green-50' 
//                   : selectedDay === daySchedule.day 
